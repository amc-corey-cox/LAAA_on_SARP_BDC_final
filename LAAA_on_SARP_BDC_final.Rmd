...
imputed_phenos %>% write_tsv("SARP1_2_imputed_phenos_mapping_2.txt")

# imputed_phenos_tmp <- imputed_phenos %>% select(-asthma)
# imputed_phenos %>% 
#   mutate(across(where(is.character), as_factor)) %>%
#   summary
# 
# imputed_phenos_old <- read_tsv("SARP1_2_imputed_phenos_mapping.txt")
# imputed_phenos_old <- imputed_phenos_old %>% head(193)
# imputed_phenos_old %>% write_tsv("SARP1_2_imputed_phenos_mapping_test.txt")
# 
# imputed_phenos_old %>%
#   filter(age >= 12) %>% write_tsv("SARP1_2_imputed_phenos_mapping_test.txt")
...
intersect(imputed_phenos$TopMed_ID, SARP1.2_wgs_phenos$sample_id)
```
