...
### Data files
* `Complete_SARP_CSGA_3-4-21_cut.adjusted.20200308.tsv`
  - Complete "locked" phenotype file for SARP 1/2,  CSGA and SARP 3
  - Originally from Complete SARP CSGA 3-4-21 cut.xlsx
  - Received from Victory Ortega 4-Mar-2021
  - Cleanup and select variables with clean_Complete_SARP_CSGA_pheno.R
...
pheno_IDs <- pheno %>% filter(! is.na(TopMed_ID) & ! duplicated(TopMed_ID) & `SARP ethnic group` == "AA") %>% select(TopMed_ID)
pheno_IDs %>% nrow
